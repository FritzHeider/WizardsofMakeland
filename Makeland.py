...
rooms = {
    "Tavern": {
        "description": "You're in a cozy tavern warmed by an open fire. On the walls you see Makelands coat of arms",
        "exits": {"outside": "Outside"},
    },
    "Outside": {
        "description": "You're standing outside a tavern. It's raining. In the distance you see Makeschool Tower",
        "exits": {"inside": "Tavern"},
    }
}
